...
public class SVG: SVGElement {
    ...
    override public var elementName: String { "svg" }
...
public class Group: SVGElement {
    override public var elementName: String { "g" }
}

public class Path: SVGElement {
    override public var elementName: String { "path" }
}
...
public class Definitions: SVGElement {
    override public var elementName: String { "defs" }
}

public class ClipPath: SVGElement {
    override public var elementName: String { "clipPath" }
}

public class LinearGradient: SVGElement {
    override public var elementName: String { "linearGradient" }
}

public class Stop: SVGElement {
    override public var elementName: String { "stop" }
}
